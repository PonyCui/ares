...
- (NSAttributedString *)createAttributedString:(ARESView *)view {
    ...
    if ([view currentState].strokeColor != nil) {
        [attributes setObject:[view currentState].strokeColor forKey:NSStrokeColorAttributeName];
    }
    [attributes setObject:@([view currentState].lineWidth) forKey:NSStrokeWidthAttributeName];
